...
// Legacy alert component with left border accent.
type LegacyAlertColor = {
  background: string;
  border: string;
  text: string;
  icon: string;
...
type LegacyAlertCategory = "success" | "danger" | "warning" | "info";
const legacyAlertColors: Record<
  LegacyAlertCategory,
  LegacyAlertColor
> = {
  success: {
...
function LegacyAlert({
  ...
  title: string;
  category: LegacyAlertCategory;
  description?: React.ReactNode;
  descriptionList?: string[];
}) {
  const colors = legacyAlertColors[category];
